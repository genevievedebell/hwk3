...
```
```{r}
# Safer way to load the workspace file
if (file.exists("submission2/Hwk3_workspace.RData")) {
    load("submission2/Hwk3_workspace.RData")
    print("Workspace successfully loaded.")
} else {
    print("Workspace file not found, skipping load.")
}

if (file.exists("submission2/Hwk3datacode_workspace.RData")) {
    load("submission2/Hwk3datacode_workspace.RData")
    print("Data code workspace successfully loaded.")
} else {
    print("Data code workspace file not found, skipping load.")
}
```
